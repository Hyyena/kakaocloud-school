...
app.get("/img/:pictureurl", (req, res) => {
  ...
  // 이미지 파일의 절대경로 생성
  let file = `C:/Users/user/Desktop/kakaocloud-school/FE/Node-project/221125/public/img/${pictureurl}`;
...
// 현재 날짜를 문자열로 리턴하는 함수
// 요즘 등장하는 JavaScript 라이브러리들의 샘플 예쩨는
// 특별한 경우가 아니면 function을 사용하지 않는다.
const getDate = () => {
  let date = new Date();
